...
class Product(models.Model):
    ...
    type = models.CharField(verbose_name='Tipo do produto', choices=CHOICES_TYPES, default=1, max_length=2)
    value = models.CharField(verbose_name='Valor do produto', max_length=10)
